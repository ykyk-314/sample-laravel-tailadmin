<x-admin.app-layout>
    ...
    <x-slot name="page">ユーザー一覧</x-slot>

    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <x-admin.breadcrumb page="ユーザー一覧" />
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-black dark:text-white">{{ $user->created_at }}</p>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <a href="{{ route('admin.users.show', $user) }}" class="hover:text-primary">
